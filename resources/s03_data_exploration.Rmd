...
# extract demography
all_test_abc$model <- gsub("/|/test", "", str_extract(all_test_abc$source_file, "/[a-z]+/test"))
...
all_test_perf <- bind_rows(all_test_keras %>%
                             dplyr::select(ID, model, m, n, true_tf, pred_tf_mean) %>%
                             rename(pred_tf = pred_tf_mean), 
                           all_test_abc %>% 
                             dplyr::select(ID, model, m, n, truth, pred_median) %>%
...
loglogscatter <- function(data, var1, var2, xlab, ylab, title){
...
plot_abc_s_error <- loglogscatter(test_sample, sweepS, abc_error, "s", "Squared error", "ABC")

plot_dnn_s_error <- loglogscatter(test_sample, sweepS, dnn_error, "s", "Squared error", "DNN")

plot_cnn_s_error <- loglogscatter(test_sample, sweepS, cnn_error, "s", "Squared error", "CNN")

plot_cnndnn_s_error <- loglogscatter(test_sample, sweepS, cnndnn_error, "s", "Squared error", "CNN+DNN")

plot_abc_ta_error <- loglogscatter(test_sample, ta, abc_error, "Sweep age", "Squared error", "ABC")

plot_dnn_ta_error <- loglogscatter(test_sample, ta, dnn_error, "Sweep age", "Squared error", "DNN")

plot_cnn_ta_error <- loglogscatter(test_sample, ta, cnn_error, "Sweep age", "Squared error", "CNN")

plot_cnndnn_ta_error <- loglogscatter(test_sample, ta, cnndnn_error, "Sweep age", "Squared error", "CNN+DNN")
