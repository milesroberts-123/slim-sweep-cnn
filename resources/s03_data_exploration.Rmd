...
params = read.table(paste(input_path, "config/parameters.tsv", sep = ""), sep = "\t", header = T)
...
strat_sample <- strat_sample %>% filter((n == i) & (m == j))
...
plot_best_abc = compare_predictions_truth_scatter(log10(best_abc$pred_median), log10(best_abc$truth), "ABC, rej., Med., tol = 0.025", "log10(True tf)", "log10(Predicted tf)", log10(test_sample$ta),"log10\nsweep\nage")

plot_best_cnn = compare_predictions_truth_scatter(test_pred_vs_act$tf_mean, test_pred_vs_act$tf, "CNN", "log10(True tf)", "log10(Predicted tf)", log10(test_pred_vs_act$ta),"log10\nsweep\nage")

plot_best_dnn = compare_predictions_truth_scatter(test_pred_vs_act_dense$tf_mean, test_pred_vs_act_dense$tf, "DNN", "log10(True tf)", "log10(Predicted tf)", log10(test_pred_vs_act_dense$ta), "log10\nsweep\nage")

plot_best_cnndnn = compare_predictions_truth_scatter(test_pred_vs_act_cnndnn$tf_mean, test_pred_vs_act_cnndnn$tf, "CNN+DNN", "log10(True tf)", "log10(Predicted tf)", log10(test_pred_vs_act_cnndnn$ta), "log10\nsweep\nage")
...
ggsave(paste(output_path, "best_models_", today, ".png", sep = ""), height = 11, width = 11, dpi = 600)
ggsave(paste(output_path, "best_models_", today, ".pdf", sep = ""), height = 11, width = 11)
```
