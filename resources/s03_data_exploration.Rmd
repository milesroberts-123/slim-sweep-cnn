...
tf <- read.table("/global/scratch/users/milesroberts/josephs_lab_projects/slim-sweep-cnn/results/2026-04-03/fixation_times.txt", sep = " ", header = T)
...
sweep_stats$ID <- as.numeric(gsub("/|_", "", str_extract(sweep_stats_files, "/[0-9]*_")))

sweep_stats$n <- as.numeric(gsub("/|_", "", str_extract(sweep_stats_files, "_[0-9]*_")))

sweep_stats$m <- as.numeric(gsub(".tsv|_", "", str_extract(sweep_stats_files, "_[0-9]*.tsv")))
...
ggplot(params, aes(x = tf, y = Etf)) +
  ...
  labs(x = "Observed tf", y = "Theoretical expectation")
