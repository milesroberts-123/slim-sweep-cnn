...
tf <- read.table("/global/scratch/users/milesroberts/josephs_lab_projects/slim-sweep-cnn/results/2026-04-18/fixation_times.txt", sep = " ", header = T)
...
sweep_stats <- fread(paste(input_path, "workflow/sweep_stats_2026-04-18.txt", sep = ""))
