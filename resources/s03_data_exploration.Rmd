...
tf <- read.table("/global/scratch/users/milesroberts/josephs_lab_projects/slim-sweep-cnn/results/2026-04-26/fixation_times.txt", sep = " ", header = T)
...
strat_sample = read.table(paste(input_path, "results/2026-04-26/partitioned_parameters.tsv", sep = ""), header = T, sep = "\t")
...
ggsave(paste(output_path, "best_models_", today, ".png", sep = ""), height = 5, width = 14, dpi = 600)
```
