...
tf <- read.table("/global/scratch/users/milesroberts/josephs_lab_projects/slim-sweep-cnn/results/2026-04-30/fixation_times.txt", sep = " ", header = T)
...
ggplot(pred_tf, aes(x = Etf, y = tf)) +
  ...
  #geom_smooth(method = "loess", lwd = 1.5, color = "grey") +
  scale_x_log10() +
  scale_y_log10() +
...
params %>% group_by(n, m) %>% summarize(count = n())
