...
tf <- read.table("/global/scratch/users/milesroberts/josephs_lab_projects/slim-sweep-cnn/results/2026-04-20/fixation_times.txt", sep = " ", header = T)
