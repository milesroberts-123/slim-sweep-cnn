...
train_abc = function(train_sample, val_sample, outcomes, summary_stats, tol, method){
  ...
  for(i in 1:nrow(val_stats)){
    ...
    result = invisible(capture.output(abc(val_target, train_outcomes, train_stats, tol, method)))
...
train_abc(train_sample, val_sample, "tf", summary_stats, 0.05, "rejection", "median")
