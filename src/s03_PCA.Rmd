...
#ggsave(paste("../results/actual_vs_predicted_fix_time_distribution_", today, ".png", sep = ""), height = 7, width = 7)
...
ggsave(paste("../results/test_actual_vs_predicted_", today, ".png", sep = ""), height = 7, width = 7)
