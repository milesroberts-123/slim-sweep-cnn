...
summary_stats = c("S", "pi", "thetaw", "tajd", "tajd_var", "num_haplos", "h1", "h2", "h12", "h123", "h2h1", "gkl_var", "gkl_skew", "gkl_kurt", "zns", "omega", "hscan")

cv.res.rej.median <- cv4abc(data.frame(tf=strat_sample$tf), strat_sample[,summary_stats], nval=nval, tols=tols, method="rejection", statistic = "median")
