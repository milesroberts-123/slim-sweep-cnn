...
## training set
train_pred_vs_act$V2 = log10(train_pred_vs_act$V2)
...
ggsave(paste("../results/", today, "/train_actual-vs-predicted_density_", today, ".png", sep = ""), height = 7, width = 7)
...
ggsave(paste("../results/", today, "/val_actual-vs-predicted_density_", today, ".png", sep = ""), height = 7, width = 7)
...
ggsave(paste("../results/", today, "/test_actual-vs-predicted_density_", today, ".png", sep = ""), height = 7, width = 7)
...
ggplot(aes(x = V2, y = V3), data = train_pred_vs_act) +
  ...
  labs(x = "log10(Actual fixation time, generations)", 
       ...
       title = paste("r = ", cor_est, ", 95 % CI = [",  cor_lwb, ", ", cor_upb, "] , p = ", cor_pvalue, sep = ""))

ggsave(paste("../results/", today, "/train_actual-vs-predicted_scatter_", today, ".png", sep = ""), height = 7, width = 7)
...
ggsave(paste("../results/", today, "/val_actual-vs-predicted_scatter_", today, ".png", sep = ""), height = 7, width = 7)
...
ggsave(paste("../results/", today, "/test_actual-vs-predicted_scatter_", today, ".png", sep = ""), height = 7, width = 7)
...
ggplot(aes(x = V2, y = V4), data = test_pred_vs_act) +
  ...
  theme_classic() +
  labs(x = "log10(Actual fixation time, generations)", 
       y = "SD in log10(Predicted fixation time, generations)",
       title = paste("r = ", cor_est, ", 95 % CI = [",  cor_lwb, ", ", cor_upb, "] , p = ", cor_pvalue, sep = ""))

ggsave(paste("../results/", today, "/test_actual-vs-predicted-sd_scatter_", today, ".png", sep = ""), height = 7, width = 7)
...
ggsave(paste("../results/", today, "/val_actual-vs-predicted-sd_scatter_", today, ".png", sep = ""), height = 7, width = 7)
...
ggplot(aes(x = V2, y = V4/V3), data = test_pred_vs_act) +
  ...
  theme_classic() +
  labs(x = "log10(Actual fixation time, generations)", 
       y = "CV in log10(Predicted fixation time, generations)",
       )

# Measure error between actual and predicted
# How does error correlate with simulation parameters?
test_pred_vs_act$error = abs(test_pred_vs_act$V2 - test_pred_vs_act$V3)
...
write.table(strat_sample, "stratified_sample_2.tsv", sep = "\t", quote = F, row.names = F)
