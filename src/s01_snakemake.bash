...
snakemake --cluster "sbatch --time 7-00:00:00 --partition=josephsnodes --account=josephsnodes --cpus-per-task={threads} --mem-per-cpu={resources.mem_mb_per_cpu}" --jobs 10 --cores 10 --use-conda --rerun-incomplete --rerun-triggers mtime --retries 2
